        	<div id="loginHolder">
                ...
                <div class="dropdown  pull-left">
                    ...
                    <ul class="dropdown-menu" style="right:0; left:auto; min-width:250px">
                        ...
                        <li><a href="#modalAbout52" role="button" class="link" data-toggle="modal" id="linkAbout52"><img src="/img/52_street_sign.png" style="height:45px; width:auto" /> About 52nd Street Tool</a></li>
                        <li class="divider"></li>
                        <li><a href="#modalAboutLJ" role="button" class="link" data-toggle="modal" id="linkUser"><img src="/img/lj_logo_alone.png" style="height:45px; width:auto" /> About Linked Jazz Project</a></li>
					...
					?>
                        ...
                        <div class="dropdown pull-left">
                            ...
                            <ul class="dropdown-menu" style="right:0; left:auto;">
                                ...
                                <!-- <li class="divider"></li> -->
                                <li><a href="/login/?loginLogout=true">Logout</a></li>
                            </ul>
                        </div>                       
                    
<!--                    	<a href="#modalUser" role="button" class="link" data-toggle="modal" id="linkUser"><i style="color:#08C" class="icon-user">&nbsp;</i>&nbsp;<?=$userName?></a><span>&nbsp;|&nbsp;</span><a href="/login/?loginLogout=true">Logout</a>
-->					<?
				}else{
					?>
    ...
    <div class="modal hide" id="modalAbout52" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAbout52" aria-hidden="true">
      ...
      <div class="modal-body">
    		<div class="thumbnail" style="text-align:center;"><img src="/img/Great_Day_in_Harlem.jpg"><a href="http://www.artkane.com/">Art Kane</a> — A Great Day In Harlem, 1958</div>
    ...
    <div class="modal hide" id="modalAboutLJ" tabindex="-1" role="dialog" aria-labelledby="myModalLabelAboutLJ" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <div class="pull-left" style="width:27%">
        	<img src="/img/lj_logo_alone.png" style="height:140px; width:auto" />
    	</div>
