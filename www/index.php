...
<!DOCTYPE html>
    <head>
		...
		$(document).ready(function($) {
			...
			fs.bind = function(){
				...
				$(".linkInerviewItem").bind("click",function(event){
					...
					if(!signedIn){
						...
						$("#linkGoogleLogin").attr("href","/login/?loginGoogle=true&urlForward=" + fs.urlForward);
						$("#linkTwitterLogin").attr("href","/login/?loginTwitter=true&urlForward=" + fs.urlForward);
						$("#linkFacebookLogin").attr("href","/login/?loginFacebook=true&urlForward=" + fs.urlForward);												
			...
			fs.loginUser = function(){
				...
				$.post("/login/?loginOrganic=true", loginObj, function(data){					
					if (data.error){		
			...
			fs.resetUser = function(){
				...
				$.post("/login/?loginForgot=true", loginObj, function(data){					
					if (data.error){		
						$("#modalLoginRegisterFormAlert").text("Uh-oh: " + data.reason);
						$("#modalLoginRegisterFormAlert").css("display","block");
			...
			fs.registerUser = function(){
				...
				$.post("/login/?loginRegister=true", registerObj, function(data){
    ...
    <body>
        ...
        <!-- <div id="mainPageFeedback"><a href="https://docs.google.com/forms/d/1pW3dQv0eYcA1ZRVhEHLaYOpZZTePmQ-_re1abjW4Q-Q/viewform">We need your feedback, tell us what you think&nbsp;<img src="/img/feeback.png"></a></div> -->
        ...
        <div class="container" id="containerHomePage"> 
            ...
            <br>
                    ...
                    <?
						...
						foreach ($results as &$ar) {
							...
							?>
                              ...
                              <li class="span2">
                                <a href="/work/<?=$uriShort?>" class="linkInerviewItem">
                                    <div class="thumbnail" data-trigger="hover" data-placement="top" rel="popover" data-title="<? echo $ar['interviewee'] . " ($percentCompleteReal% done)" ?>" data-content="<?=$popOverContent?>">
                                      ...
                                      <img src="/img/square/<?=$uriShort?>.png" alt="">
            	...
            	<div style="text-align:center">This is a prototype tool under active development, if you have any comments or ideas we would <a href="mailto:foaf.Person@semlab.io">love to hear them!</a></div>
            	<br style="clear:both;">
            ...
            <div class="homePageHero" id="footer">
            	...
            	<div class="footerMenu">
                    ...
                    <ul class="breadcrumb" style="background-color:#fff">
                      ...
                      <li><a href="mailto:foaf.Person@semlab.io">Contact Us</a> <span class="divider">/</span></li>
                      <li><a href="/">Linked Jazz Homepage</a></li>
                    </ul>                
                		
                       <span style="font-size:12px;">
                       <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/deed.en_US"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/3.0/80x15.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Linked Jazz</span> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/deed.en_US">Creative Commons Attribution-ShareAlike 3.0 Unported License</a>.  
					 </span>
                     <br>
